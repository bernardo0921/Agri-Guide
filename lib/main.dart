...
// Firebase options generated by `flutterfire configure` will provide
// DefaultFirebaseOptions.currentPlatform. A placeholder file exists so
// the app builds until you run the CLI.
...
void main() async {
  ...
  // Initialize Firebase (needed for push notifications)
  try {
    await Firebase.initializeApp(options: DefaultFirebaseOptions.currentPlatform);
  } catch (e) {
    // If `firebase_options.dart` hasn't been generated yet,
    // fall back to default initialization (requires native config files).
  ...
  // Initialize push notification service (FCM -> Local)
